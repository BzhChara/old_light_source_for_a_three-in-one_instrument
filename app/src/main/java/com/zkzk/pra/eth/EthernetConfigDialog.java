...
//    private IPEditText mIpaddr;
//    private IPEditText mDns;
...
//        mIpaddr = (IPEditText)mView.findViewById(R.id.ipaddr_edit);
//        mDns = (IPEditText)mView.findViewById(R.id.eth_dns_edit);
...
//        	String ip=mIpaddr.getText(),
//        			dns=mDns.getText();
//
//
//        	if("".equals(ip)) {
//        		ToastUtil.showText(R.string.show_need_setting, Toast.LENGTH_SHORT);
//        	}else {
//        		info.setConnectMode(EthernetDevInfo.ETHERNET_CONN_MODE_MANUAL);
//                info.setIpAddress(ip);
//                if("".equals(dns)) {
//                	dns=ip.substring(0, ip.lastIndexOf('.'))+".1";
//                }
//                info.setDnsAddr(dns);
//        	}
//
