...
//
//public class EtherActivity extends BaseActivity {
...
//                mEthConfigDialog = new EthernetConfigDialog(EtherActivity.this, mEthEnabler);
...
//                mSaveConfig = mEthEnabler.getManager().getSavedConfig();
//                if (mSaveConfig != null) {
//                    mEthAdvancedDialog = new EthernetAdvDialog(EtherActivity.this,mEthEnabler);
