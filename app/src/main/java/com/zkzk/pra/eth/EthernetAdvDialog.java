...
//        mContext = context;
//        mEthEnabler = Enabler;
//        LinkProperties mLinkProperties = new LinkProperties();//这个类在API level 21
...
//
//        mProxyIp = (IPEditText)mView.findViewById(R.id.proxy_address_edit);
...
//            info.setProxyAddr(mProxyIp.getText());
...
//        }else{
//           ToastUtil.showText(R.string.show_connect_ethernet,Toast.LENGTH_SHORT);
//        }
//    }
//
