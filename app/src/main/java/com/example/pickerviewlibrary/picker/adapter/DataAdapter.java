...
public class DataAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.data_layout = (LinearLayout) convertView.findViewById(R.id.data_layout);
            viewHolder.textView = (TextView) convertView.findViewById(R.id.data_text);
            viewHolder.data_img = (ImageView) convertView.findViewById(R.id.data_img);
